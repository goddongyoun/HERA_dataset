...
The inherited `hera_v2` module name and some CLI descriptions are historical names, not a substitution of v2 results. This package preserves the final v3 execution snapshot exactly. Running the new experiment workflow is not necessary merely to inspect or upload this repository.
